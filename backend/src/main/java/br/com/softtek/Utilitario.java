...
public class Utilitario {
    ...
    public void Instanciar() {
        ...
        categoria2
            ...
            .setSubTipo(Categoria.SubTipo.SOLICITACAO);
        categoria3
            .setId(3)
            .setSintoma(sintoma2)  
        ...
        chamado1
            ...
            .setDescricao("Um servidor de dados em nosso escritório está apresentando dados incoerentes e mal funcionamento, favor verificar com urgência.")
        ...
        chamado2
            ...
            .setUsuario(usuario2)
            .setNumero("67789002")
            .setTipo(Chamado.Tipo.REQUISICAO)
            .setStatus(Chamado.Status.RESOLVIDO)
            .setPrioridade(Chamado.Prioridade.BAIXO)
            .setDescricao("Criar usuário de rede")
        ...
        logs2
            ...
            .setDescricao("Usuário de rede criado e enviado os dados ao gestor imediato.");
        sintoma1
            .setId(1)
            .setNome("Mal funcionamento do equipamento")
            .setQualificacao("Informação");
        sintoma2
            .setId(2)
            .setNome("Criação de Acesso")
            .setQualificacao("Com SAP");
        usuario1
            .setId(1)
            .setNome("Roberto Almeida Santos")
            .setEmail("roberto@softtek.com.br")
            .setSenha("123456")
